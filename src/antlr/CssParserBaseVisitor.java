...
public class CssParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CssParserVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitAnyValueUntilBrace(CssParser.AnyValueUntilBraceContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitAnyValueUntilSemicolon(CssParser.AnyValueUntilSemicolonContext ctx) { return visitChildren(ctx); }
}