...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- Starting Parser for file: " + fileName + " ---");
        ...
        try {
            ...
            System.out.println("\n--- Parsing SUCCESSFUL! ---");
            System.out.println("The input file '" + fileName + "' is valid according to the grammar.");

            // System.out.println(antlrAST.toStringTree(parser));

        } catch (Exception e) {

            System.err.println("\nParsing halted due to error: " + e.getMessage());
            // e.printStackTrace();
        }
    }
